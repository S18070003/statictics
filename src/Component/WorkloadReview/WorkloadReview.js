...
import '../WorkloadReview/WorkloadReview.css';
...
class Table2 extends React.Component{
    ...
    handleSubmitReview = () => {
        const submitsul =API.URL+ 'WorkloadReview/submitReview.php';
    ...
    showModal = (submitTime) => {
        ...
        const submitsul = API.URL+'WorkloadReview/getReviewdata.php';
        fetch(submitsul, {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
            },
    ...
    getdata=()=>{
        const  url=API.URL+'WorkloadReview/getReview.php';
        const data='checker='+sessionStorage.getItem('Realname');
        fetch(url, {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
            },
    ...
    deletedata=(submitTime)=>{
        let data = 'submitTime=' + submitTime;
        const submitsul =API.URL+ 'WorkloadReview/delete_workload.php';
        fetch(submitsul, {
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
            },
    ...
    render(){
        ...
        const columns = [{
            ...
            render: (text,record) =>(
             //  {/*<div>*/}
            //   {/*<a href="#" onClick={this.download.bind(this,record.FilePath)}>{text}</a>*/}
            //   {/*<iframe ref="ifile" style="display:none"></iframe>*/}
             //  {/*</div>*/}
              //  <a onClick={()=>this.downLoad(record.FilePath,record.FileName)}>{text}</a>
