...
class RegistrationForm extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                const url=API.URL+'UserManage/UserAlter.php';
            ...
            <Form {...formItemLayout} onSubmit={this.handleSubmit}>
                <Form.Item label="账号" >
                    {getFieldDecorator('Username', {
                        ...
                        <Input defaultValue={value.Username} type="username" disabled/>
                    )}
                </Form.Item>
                ...
                <Form.Item label="部门">
                    {getFieldDecorator('Department', {
                        initialValue:[value.FirstDep,value.SecondDep,value.ThirdDep,value.ForthDep],
...
const AlterUser = Form.create({ name: 'register' })(RegistrationForm);
